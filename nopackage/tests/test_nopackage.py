...
from nopackage import PackageInfo

from nopackage import find_all_any_ci

from nopackage import tests
...
class TestNopackage(TestCase):
    def test_self(self):
        ...
        print()
        print()
        print("BEGIN nopackage self tests")
        tests()
        print("END nopackage self tests")
        print()
        print()
        print()
